...
public class AvailabilityLane extends Lane<OffsetDateTime> {

    private final EmployeeAvailabilityState availabilityState;
    ...
    public AvailabilityLane(final EmployeeAvailabilityState availabilityStateParam,
                            final List<SubLane<OffsetDateTime>> subLanes) {

        super(availabilityStateParam.toString(), subLanes);
        this.availabilityState = availabilityStateParam;
    }

    public EmployeeAvailabilityState getAvailabilityState() {
