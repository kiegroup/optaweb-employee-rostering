...
public class Positive2HoursScale implements LinearScale<LocalDateTime> {
    ...
    public Long toGridPixelsWithFactor1(final LocalDateTime valueInScaleUnits) {
        ...
        return Duration.between(instantOf(OffsetDateTime.of(start, ZoneOffset.UTC)), instantOf(OffsetDateTime.of(valueInScaleUnits, ZoneOffset.UTC))).getSeconds() / 60 / 60;
    }
