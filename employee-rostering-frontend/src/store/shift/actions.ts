...
export const addShift: ActionFactory<Shift, AddShiftAction> = newShift => ({
  type: ActionType.ADD_SHIFT,
  shift: newShift
});

export const removeShift: ActionFactory<Shift, RemoveShiftAction> = deletedShift => ({
  type: ActionType.REMOVE_SHIFT,
  shift: deletedShift
});

export const updateShift: ActionFactory<Shift, UpdateShiftAction> = updatedShift => ({
  type: ActionType.UPDATE_SHIFT,
  shift: updatedShift
});

export const refreshShiftList: ActionFactory<Shift[], RefreshShiftListAction> = newShiftList => ({
