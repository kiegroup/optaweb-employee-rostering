...
import org.optaweb.employeerostering.gwtui.client.viewport.powers.DraggabilitySupplier;
import org.optaweb.employeerostering.gwtui.client.viewport.powers.ResizabilitySupplier;
...
public class ShiftGridObject extends AbstractHasTimeslotGridObject<ShiftRosterMetadata>
    ...
    @Inject
    private DraggabilitySupplier<LocalDateTime, ShiftRosterMetadata> draggability;
    @Inject
    private ResizabilitySupplier<LocalDateTime, ShiftRosterMetadata> resizability;
    @Inject
