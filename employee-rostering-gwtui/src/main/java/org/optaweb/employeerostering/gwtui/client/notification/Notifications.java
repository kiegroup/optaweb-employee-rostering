...
public class Notifications
    ...
    public void showError(Throwable throwable) {
        ...
        ToastNotification notification = toastNotificationInstance.get();
        notification.setup(NotificationType.ERROR, OptaWebUIConstants.Notifications_exception, new NotificationAction(OptaWebUIConstants.Notifications_viewStackTrace, () -> ErrorPopup.show(message
                                                                                                                                                                                                    .toString())),
