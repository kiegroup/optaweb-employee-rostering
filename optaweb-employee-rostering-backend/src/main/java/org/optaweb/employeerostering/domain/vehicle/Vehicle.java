...
public class Vehicle extends AbstractPersistable {
    ...
    @JoinTable(name = "VehicleSkillProficiencySet",
            joinColumns = @JoinColumn(name = "vehicleId", referencedColumnName = "id"),
    ...
    public Vehicle(Integer tenantId, String name,
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name, skillProficiencySet);
    }
}
