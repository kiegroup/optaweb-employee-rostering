...
public class NonCovidShiftSoonAfterCovidShiftViolation implements ConstraintMatchView {
    ...
    public NonCovidShiftSoonAfterCovidShiftViolation() {

    }

    public NonCovidShiftSoonAfterCovidShiftViolation(Shift covidShift, Shift nonCovidShift,
